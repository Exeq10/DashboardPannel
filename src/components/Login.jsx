  ...
  const {setAuth}= useContext(UserContext)
    ...
    return (
      <section className="w-screen h-screen flex items-center justify-center bg-gray-100  ">
        {/* cuadro de login */}
        <div className="w-3/12 bg-white flex flex-col p-3 justify-center items-center gap-10 rounded-md shadow-md">
          {/* formulario de login  */}
          ...
          <form onSubmit={(e) => handleSubmit(e)} className="flex justify-center items-center flex-col gap-5" >
            {/* div del logo  */}
            {/* input de usuario  */}
            {errores?.length > 0 ? <p className="text-red-500">{errores} </p> : ""}
           ...
           <div className=" flex flex-col justify-center items-start ">
             ...
             <input type="text" className="py-1 px-3 rounded-md border border-sky-700"
           ...
           <div className="flex flex-col justify-center items-start">
            ...
            <div className=" flex flex-col justify-center items-center gap-4">
              <input type="submit" value={"Login"} className="bg-sky-700 text-white w-full py-1 px-3 rounded-md"  />
